...
import { activateUser, verifyActivationOTP, login, verifyLoginOTP, getNotifications, updateNotification, updateSalary } from '../controller/userController';
...
const UserRouter = (io: any) => {
  ...
  router.patch('/notifications/:id', catchAsync(updateNotification));
